...
HAPPY_PATH_MODE = os.getenv("SYNDIMATCH_HAPPY_PATH", "false").lower() == "true"

if HAPPY_PATH_MODE:
    MIN_SUBSCRIPTION_RATE = min(MIN_SUBSCRIPTION_RATE, 0.40)
    EARLY_CLOSE_THRESHOLD = min(EARLY_CLOSE_THRESHOLD, 0.60)
    MAX_AUCTION_ROUNDS = min(MAX_AUCTION_ROUNDS, 3)
