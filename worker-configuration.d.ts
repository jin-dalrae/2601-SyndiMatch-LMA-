/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 31e08df94bc84d8bfb524a58ad26f3f7)
// Runtime types generated with workerd@1.20260921.1 2026-09-24 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	REVIEWER_ID: "credit-committee-reviewer";
	...
	CDP_WALLET_DATA: string;
	CDP_NETWORK: string;
	PLATFORM_WALLET: string;
	PLATFORM_FEE_PCT: string;
	AGENT_SERVER_PORT: string;
	WS_PORT: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REVIEWER_ID" | "SESSION_TTL_SECONDS" | "MONGODB_URI" | "PORT" | "AGENTS_SERVICE_URL" | "ENVIRONMENT" | "DATABASE_NAME" | "ANTHROPIC_API_KEY" | "GEMINI_API_KEY" | "CDP_API_KEY_NAME" | "CDP_API_KEY_PRIVATE_KEY" | "CDP_WALLET_DATA" | "CDP_NETWORK" | "PLATFORM_WALLET" | "PLATFORM_FEE_PCT" | "AGENT_SERVER_PORT" | "WS_PORT">> {}
}
